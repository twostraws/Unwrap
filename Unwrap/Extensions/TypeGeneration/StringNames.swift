...
extension String: TypeGenerating {
    static func randomName() -> (name: String, nameNatural: String, values: [String]) {
        let names = [
            ...
            "favorite color": ["beige", "black", "blue", "brown", "cyan", "crimson", "fuchsia", "gold", "green", "indigo", "lilac", "magenta", "orange", "pink", "purple", "red", "scarlet", "teal", "turquoise", "violet", "white", "yellow"],
