...
extension String {
    ...
    func toAnonymizedVariables() -> String {
        ...
        // Homogenize one line guard statement to reduce the number of possible solutions
        replaced = homogenizeGuardStatements(in: replaced)
    ...
    /**
     Homogenize all one line guard statements in code to reduce the number of possible solutions
     ...
     ```
     */
    func homogenizeGuardStatements(in code: String) -> String {
        var replaced = code
